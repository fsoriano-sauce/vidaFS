================================================================================
CLIENT BROWSER SHORTCUTS - SETUP INSTRUCTIONS FOR ANA
================================================================================
...
WHAT'S INCLUDED:
----------------
1. Ana_Desktop_Shortcuts.zip  - Desktop shortcut icons for each client
2. Ana_Dashboards.zip          - Client dashboard HTML files
3. SETUP_FOR_ANA.bat          - Automated setup script (THIS IS EASIEST!)
4. README_FOR_ANA.txt         - This file


EASY SETUP (RECOMMENDED):
-------------------------
1. Extract the package to any folder
2. Right-click "SETUP_FOR_ANA.bat" 
3. Select "Run as Administrator"
4. Follow the prompts!

The script will automatically:
- Clean up old Ana shortcuts and dashboards
- Install the new shortcuts and dashboards
- Preserve your existing logins/profiles

MANUAL SETUP (IF YOU PREFER):
------------------------------
1. Create folder: C:\Automation\Ana_Profiles
   
2. Create folder: C:\Automation\Dashboards

3. Extract "Ana_Dashboards.zip" to C:\Automation\Dashboards

4. Extract "Ana_Desktop_Shortcuts.zip" to your Desktop
...
A: Make sure profiles are at: C:\Automation\Ana_Profiles
